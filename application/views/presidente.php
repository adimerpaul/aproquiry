...
<head>
    ...
    <title>Code Editor | jeweler - Material Admin Template</title>
...
<div class="left-sidebar-pro">
    <nav id="sidebar" class="">
        <div class="sidebar-header">
            ...
            <strong><img src="<?=base_url()?>img/logo/logosn.png" alt="" /></strong>
        </div>
...
<!-- code editor JS
    ============================================ -->
<script src="<?=base_url()?>js/code-editor/codemirror.js"></script>
<script src="<?=base_url()?>js/code-editor/code-editor.js"></script>
<script src="<?=base_url()?>js/code-editor/code-editor-active.js"></script>
<!-- tab JS
    ============================================ -->
