...
class Ingresos extends CI_Controller
{
    public function index(){
        ...
        $data['title']="Usted esta en la opcion: Registrar ingresos";
        $data['css']="
...
<script src='".base_url()."js/jquery-1.9.1.js'></script>
    ...
    public function insert(){
        ...
        $this->db->query("INSERT INTO ingreso(cantidad,descripcion,idusuario,ncomprobante,nombre) 
      VALUES('$cantidad','$descripcion','".$_SESSION['idusuario']."','$ncomprobante','$nombre')");
