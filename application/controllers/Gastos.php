...
class Gastos extends CI_Controller
{
    public function index(){
        ...
        $data['title']="Usted esta en la opcion: Registrar Gastos";
        $data['css']="
...
<script src='".base_url()."js/jquery-1.9.1.js'></script>
    ...
    public function insert(){
        ...
        $this->db->query("INSERT INTO gasto(cantidad,detalle,nombre,idusuario,ncomprobante) 
      VALUES('$cantidad','$detalle','$nombre','".$_SESSION['idusuario']."','$ncomprobante')");
